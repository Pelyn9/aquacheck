              ...
              <div style={{ width: "100%", marginTop: "20px" }}>
                ...
                <ResponsiveContainer width="100%" height={330}>
                  <AreaChart data={dailyData} margin={{ top: 20, right: 20, left: 0, bottom: 0 }}>
                    <defs>
                      <linearGradient id="PH" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#0bef17ff" stopOpacity={0.8}/><stop offset="95%" stopColor="#7EE8FA" stopOpacity={0.1}/></linearGradient>
                      <linearGradient id="Turbidity" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#4BB7A7" stopOpacity={0.8}/><stop offset="95%" stopColor="#4BB7A7" stopOpacity={0.1}/></linearGradient>
                      <linearGradient id="Temperature" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#6010ebff" stopOpacity={0.8}/><stop offset="95%" stopColor="#67C6F2" stopOpacity={0.1}/></linearGradient>
                      <linearGradient id="TDS" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#c9e20aff" stopOpacity={0.8}/><stop offset="95%" stopColor="#435B9A" stopOpacity={0.1}/></linearGradient>
                    </defs>
                    <XAxis dataKey="time" tick={{ fontSize: 12 }} />
                    <YAxis tick={{ fontSize: 12 }} />
                    <Tooltip />
                    <Legend verticalAlign="top" height={40} formatter={value => <span style={{ fontSize: "14px" }}>{value}</span>} />
