...
const AdminDashboard = () => {
  ...
  const [countdown, setCountdown] = useState(null);     // <- FIXED
    ...
    <div className="dashboard-container">
      ...
      <main className="main-content">
        ...
        <section className="scan-controls">
          ...
          <div className="button-group">
            ...
            <button
              className={`start-stop-btn ${
                localStorage.getItem("autoScanRunning") === "true" ? "stop" : "start"
              }`}
          ...
          {localStorage.getItem("autoScanRunning") === "true" && countdown !== null && (
